...
<div class="badges">
  <div class="price"> <img src="../assets/icon-ethereum.svg" alt=""> <p>0.041 ETH</p></div>
  <div class="days"> <img src="../assets/icon-clock.svg" alt=""> <p>3 days left</p> </div>
</div>
<!-- <hr> -->
<div class="created">
...
.card{
  ...
  border-radius: 17px;
  box-shadow: 0px 20px 20px 20px #0000002b;
}
.image{
  border-radius: 10px;
  position: relative;
